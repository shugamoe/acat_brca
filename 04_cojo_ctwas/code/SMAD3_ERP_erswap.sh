...
--cojo-file ../output/intermediate_data/cojo_ma_files/BCAC_ERPOS_BreastCancer_EUR_index_erswap_gwas.ma \
--cojo-cond SMAD3.cond.snplist \
--extract SMAD3.pred.snplist \
--out ../output/intermediate_data/cojo_output/BCAC_ERPOS_BreastCancer_EUR_index_erswap/ENSG00000166949.15
