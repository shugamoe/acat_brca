#!/bin/bash
#PBS -N meta_analysis_BCAC_CIMBA_erneg_brca__PM__Minor_Salivary_Gland_spredixcan_igwas_gtexmashrv8_sqtl
#PBS -S /bin/bash
...
--throw \
--output_file ../output/spredixcan_sqtl_mashr/spredixcan_igwas_gtexmashrv8_meta_analysis_BCAC_CIMBA_erneg_brca__PM__Minor_Salivary_Gland.csv