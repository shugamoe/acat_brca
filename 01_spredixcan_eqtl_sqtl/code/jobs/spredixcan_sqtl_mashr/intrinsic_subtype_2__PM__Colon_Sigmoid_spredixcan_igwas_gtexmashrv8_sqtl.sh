#!/bin/bash
#SBATCH --job-name=intrinsic_subtype_2__PM__Colon_Sigmoid_spredixcan_igwas_gtexmashrv8_sqtl
#SBATCH --time=0:30:00
#SBATCH --mem=2gb
#SBATCH --nodes=1
...
--throw \
--output_file ../output/spredixcan_sqtl_mashr/spredixcan_igwas_gtexmashrv8_intrinsic_subtype_2__PM__Colon_Sigmoid.csv