#!/bin/bash
#PBS -N BCAC_ERPOS_BreastCancer_EUR__PM__Minor_Salivary_Gland_spredixcan_igwas_gtexmashrv8_sqtl
#PBS -S /bin/bash
...
--throw \
--output_file ../output/spredixcan_sqtl_mashr/spredixcan_igwas_gtexmashrv8_BCAC_ERPOS_BreastCancer_EUR__PM__Minor_Salivary_Gland.csv