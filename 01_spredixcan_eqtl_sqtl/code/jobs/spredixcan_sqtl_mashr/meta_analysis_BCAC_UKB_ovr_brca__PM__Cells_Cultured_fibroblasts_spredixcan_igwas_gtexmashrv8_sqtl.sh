#!/bin/bash
#PBS -N meta_analysis_BCAC_UKB_ovr_brca__PM__Cells_Cultured_fibroblasts_spredixcan_igwas_gtexmashrv8_sqtl
#PBS -S /bin/bash
...
--throw \
--output_file ../output/spredixcan_sqtl_mashr/spredixcan_igwas_gtexmashrv8_meta_analysis_BCAC_UKB_ovr_brca__PM__Cells_Cultured_fibroblasts.csv