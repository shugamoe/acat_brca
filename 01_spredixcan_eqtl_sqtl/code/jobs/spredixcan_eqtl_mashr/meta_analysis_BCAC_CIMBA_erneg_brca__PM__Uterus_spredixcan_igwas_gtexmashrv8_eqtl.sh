#!/bin/bash
#PBS -N meta_analysis_BCAC_CIMBA_erneg_brca__PM__Uterus_spredixcan_igwas_gtexmashrv8_eqtl
#PBS -S /bin/bash
...
--throw \
--output_file ../output/spredixcan_eqtl_mashr/spredixcan_igwas_gtexmashrv8_meta_analysis_BCAC_CIMBA_erneg_brca__PM__Uterus.csv