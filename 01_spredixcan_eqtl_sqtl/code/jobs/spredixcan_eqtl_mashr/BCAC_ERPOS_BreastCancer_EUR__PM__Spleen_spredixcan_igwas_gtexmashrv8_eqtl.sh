#!/bin/bash
#PBS -N BCAC_ERPOS_BreastCancer_EUR__PM__Spleen_spredixcan_igwas_gtexmashrv8_eqtl
#PBS -S /bin/bash
...
--throw \
--output_file ../output/spredixcan_eqtl_mashr/spredixcan_igwas_gtexmashrv8_BCAC_ERPOS_BreastCancer_EUR__PM__Spleen.csv