#!/bin/bash
#PBS -N BCAC_Overall_BreastCancer_EUR__PM__Skin_Sun_Exposed_Lower_leg_spredixcan_igwas_gtexmashrv8_eqtl
#PBS -S /bin/bash
...
--throw \
--output_file ../output/spredixcan_eqtl_mashr/spredixcan_igwas_gtexmashrv8_BCAC_Overall_BreastCancer_EUR__PM__Skin_Sun_Exposed_Lower_leg.csv