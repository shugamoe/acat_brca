#!/bin/bash
#SBATCH --job-name=intrinsic_subtype_1__PM__Ovary_spredixcan_igwas_gtexmashrv8_eqtl
#SBATCH --time=0:30:00
#SBATCH --mem=2gb
#SBATCH --nodes=1
...
--throw \
--output_file ../output/spredixcan_eqtl_mashr/spredixcan_igwas_gtexmashrv8_intrinsic_subtype_1__PM__Ovary.csv