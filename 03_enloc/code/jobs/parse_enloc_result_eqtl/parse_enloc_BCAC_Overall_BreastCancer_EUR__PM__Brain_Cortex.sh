#!/bin/bash
#PBS -N parse_enloc_BCAC_Overall_BreastCancer_EUR__PM__Brain_Cortex
#PBS -S /bin/bash
...
with open(I) as _i:
  with gzip.open(O, "w") as _o:
    ...
    for l in _i:
        ...
        _o.write(_l.encode())
print("Done")
' ../output/enloc_eqtl/BCAC_Overall_BreastCancer_EUR__PM__Brain_Cortex.enloc.rst \
../output/parse_enloc_result_eqtl/BCAC_Overall_BreastCancer_EUR__PM__Brain_Cortex.enloc.rst.gz \
