#!/bin/bash
#PBS -N parse_enloc_BCAC_ERPOS_BreastCancer_EUR__PM__Nerve_Tibial
#PBS -S /bin/bash
...
with open(I) as _i:
  with gzip.open(O, "w") as _o:
    ...
    for l in _i:
        ...
        _o.write(_l.encode())
print("Done")
' ../output/enloc_eqtl/BCAC_ERPOS_BreastCancer_EUR__PM__Nerve_Tibial.enloc.rst \
../output/parse_enloc_result_eqtl/BCAC_ERPOS_BreastCancer_EUR__PM__Nerve_Tibial.enloc.rst.gz \
