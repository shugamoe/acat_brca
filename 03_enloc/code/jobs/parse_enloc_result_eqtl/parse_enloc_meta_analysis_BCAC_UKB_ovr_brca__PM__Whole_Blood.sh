...
with open(I) as _i:
  with gzip.open(O, "w") as _o:
    ...
    for l in _i:
        ...
        _o.write(_l.encode())
print("Done")
' ../output/enloc_eqtl/meta_analysis_BCAC_UKB_ovr_brca__PM__Whole_Blood.enloc.rst \
../output/parse_enloc_result_eqtl/meta_analysis_BCAC_UKB_ovr_brca__PM__Whole_Blood.enloc.rst.gz \
