#!/bin/bash
#PBS -N parse_enloc_meta_analysis_BCAC_CIMBA_erneg_brca__PM__Brain_Cerebellum
#PBS -S /bin/bash
...
with open(I) as _i:
  with gzip.open(O, "w") as _o:
    ...
    for l in _i:
        ...
        _o.write(_l.encode())
print("Done")
' ../output/enloc_eqtl/meta_analysis_BCAC_CIMBA_erneg_brca__PM__Brain_Cerebellum.enloc.rst \
../output/parse_enloc_result_eqtl/meta_analysis_BCAC_CIMBA_erneg_brca__PM__Brain_Cerebellum.enloc.rst.gz \
