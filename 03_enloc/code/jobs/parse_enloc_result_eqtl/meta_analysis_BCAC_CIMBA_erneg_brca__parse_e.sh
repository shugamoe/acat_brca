#!/bin/bash
#PBS -N meta_analysis_BCAC_CIMBA_erneg_brca__parse_e
#PBS -S /bin/bash
...
--input_filter meta_analysis_BCAC_CIMBA_erneg_brca__PM__.*enloc.rst.gz \
-trait_map public_gwas_filename_map.yaml \
-output ../output/final_enloc_result_eqtl/meta_analysis_BCAC_CIMBA_erneg_brca__parse_e.txt