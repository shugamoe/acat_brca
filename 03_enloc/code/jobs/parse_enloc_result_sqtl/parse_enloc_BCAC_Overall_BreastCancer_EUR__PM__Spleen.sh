#!/bin/bash
#PBS -N parse_enloc_BCAC_Overall_BreastCancer_EUR__PM__Spleen
#PBS -S /bin/bash
...
with open(I) as _i:
  with gzip.open(O, "w") as _o:
    ...
    for l in _i:
        ...
        _o.write(_l.encode())
print("Done")
' ../output/enloc_sqtl/BCAC_Overall_BreastCancer_EUR__PM__Spleen.enloc.rst \
../output/parse_enloc_result_sqtl/BCAC_Overall_BreastCancer_EUR__PM__Spleen.enloc.rst.gz \
