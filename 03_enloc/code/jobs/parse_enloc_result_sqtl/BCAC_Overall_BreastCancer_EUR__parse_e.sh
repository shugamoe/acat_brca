#!/bin/bash
#PBS -N BCAC_Overall_BreastCancer_EUR__parse_e
#PBS -S /bin/bash
...
--input_filter BCAC_Overall_BreastCancer_EUR__PM__.*enloc.rst.gz \
-trait_map public_gwas_filename_map.yaml \
-output ../output/final_enloc_result_sqtl/BCAC_Overall_BreastCancer_EUR__parse_e.txt