#!/bin/bash
#SBATCH --job-name=11tiss___meta_analysis_BCAC_CIMBA_erneg_brca_sqtl_acat_results
#SBATCH --time=4:00:00
#SBATCH --mem=16gb
#SBATCH --nodes=1
...
--tiss_rank \
--output ../output/acat_tiss_breakdown_sqtl/11tiss__meta_analysis_BCAC_CIMBA_erneg_brca_sqtl_acat_results.tsv