#!/bin/bash
#SBATCH --job-name=all_tissues___meta_analysis_BCAC_UKB_ovr_brca_sqtl_acat_results
#SBATCH --time=4:00:00
#SBATCH --mem=16gb
#SBATCH --nodes=1
...
--tiss_rank \
--output ../output/acat_tiss_breakdown_sqtl/all_tissues__meta_analysis_BCAC_UKB_ovr_brca_sqtl_acat_results.tsv