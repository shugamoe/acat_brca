#!/bin/bash
#SBATCH --job-name=11tiss___intrinsic_subtype_3_sqtl_acat_results
#SBATCH --time=4:00:00
#SBATCH --mem=16gb
#SBATCH --nodes=1
...
--tiss_rank \
--output ../output/acat_tiss_breakdown_sqtl/11tiss__intrinsic_subtype_3_sqtl_acat_results.tsv