#!/bin/bash
#SBATCH --job-name=all_tissues___intrinsic_subtype_2_sqtl_acat_results
#SBATCH --time=4:00:00
#SBATCH --mem=16gb
#SBATCH --nodes=1
...
--associations ../input/acat_prep_sqtl/intrinsic_subtype_2_sqtl_acat_input.csv SPrediXcan \
--cutoff_condition_number 30 \
--verbosity 10 \
--acat \
--tiss_list ../input/tissue_lists/all_tissues.txt \
--tiss_rank \
--output ../output/acat_tiss_breakdown_sqtl/all_tissues__intrinsic_subtype_2_sqtl_acat_results.tsv