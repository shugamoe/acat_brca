#!/bin/bash
#SBATCH --job-name=11tiss___meta_analysis_BCAC_CIMBA_erneg_brca_acat_eqtl
#SBATCH --time=4:00:00
#SBATCH --mem=16gb
#SBATCH --nodes=1
...
--output ../output/acat_eqtl/11tiss__meta_analysis_BCAC_CIMBA_erneg_brca_eqtl_acat_results.tsv