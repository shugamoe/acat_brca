#!/bin/bash
#SBATCH --job-name=all_tissues___intrinsic_subtype_5_acat_eqtl
#SBATCH --time=4:00:00
#SBATCH --mem=16gb
#SBATCH --nodes=1
...
--study_pattern "spredixcan_igwas_gtexmashrv8_intrinsic_subtype_5*" \
--tiss_list ../input/tissue_lists/all_tissues.txt \
--output ../output/acat_eqtl/all_tissues__intrinsic_subtype_5_eqtl_acat_results.tsv