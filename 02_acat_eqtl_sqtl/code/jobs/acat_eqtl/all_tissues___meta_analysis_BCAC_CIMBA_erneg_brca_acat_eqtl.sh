#!/bin/bash
#SBATCH --job-name=all_tissues___meta_analysis_BCAC_CIMBA_erneg_brca_acat_eqtl
#SBATCH --time=4:00:00
#SBATCH --mem=16gb
#SBATCH --nodes=1
...
--study_pattern "spredixcan_igwas_gtexmashrv8_meta_analysis_BCAC_CIMBA_erneg_brca*" \
--tiss_list ../input/tissue_lists/all_tissues.txt \
--output ../output/acat_eqtl/all_tissues__meta_analysis_BCAC_CIMBA_erneg_brca_eqtl_acat_results.tsv