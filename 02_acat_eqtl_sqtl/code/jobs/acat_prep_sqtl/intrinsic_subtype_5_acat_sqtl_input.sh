#!/bin/bash
#SBATCH --job-name=intrinsic_subtype_5_acat_sqtl_input
#SBATCH --time=4:00:00
#SBATCH --mem=16gb
#SBATCH --nodes=1
...
--spred_sqtl_pattern "../../01_spredixcan_eqtl_sqtl/output/spredixcan_sqtl_mashr/spredixcan_igwas_gtexmashrv8_intrinsic_subtype_5*.csv" \
--output ../input/acat_prep_sqtl/intrinsic_subtype_5_sqtl_acat_input.csv