#!/bin/bash
#PBS -N meta_analysis_BCAC_UKB_ovr_brca_chr4_sb1_by_region
#PBS -S /bin/bash
...
-sub_batch 1 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/meta_analysis_BCAC_UKB_ovr_brca_chr4_sb1_reg0.1_ff0.01_by_region.txt.gz