#!/bin/bash
#SBATCH --job-name=intrinsic_subtype_3_chr5_sb6_by_region
#SBATCH --time=4:00:00
#SBATCH --mem=5gb
#SBATCH --nodes=1
...
-sub_batch 6 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/intrinsic_subtype_3_chr5_sb6_reg0.1_ff0.01_by_region.txt.gz