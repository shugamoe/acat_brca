#!/bin/bash
#PBS -N meta_analysis_BCAC_CIMBA_erneg_brca_chr11_sb2_by_region
#PBS -S /bin/bash
...
-sub_batch 2 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/meta_analysis_BCAC_CIMBA_erneg_brca_chr11_sb2_reg0.1_ff0.01_by_region.txt.gz