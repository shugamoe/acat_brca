#!/bin/bash
#SBATCH --job-name=intrinsic_subtype_2_chr21_sb1_by_region
#SBATCH --time=4:00:00
#SBATCH --mem=3gb
#SBATCH --nodes=1
...
-sub_batch 1 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/intrinsic_subtype_2_chr21_sb1_reg0.1_ff0.01_by_region.txt.gz