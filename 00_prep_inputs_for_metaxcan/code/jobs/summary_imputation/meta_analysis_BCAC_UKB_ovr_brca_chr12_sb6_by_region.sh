#!/bin/bash
#PBS -N meta_analysis_BCAC_UKB_ovr_brca_chr12_sb6_by_region
#PBS -S /bin/bash
...
-sub_batch 6 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/meta_analysis_BCAC_UKB_ovr_brca_chr12_sb6_reg0.1_ff0.01_by_region.txt.gz