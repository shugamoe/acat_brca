#!/bin/bash
#PBS -N meta_analysis_BCAC_UKB_ovr_brca_chr16_sb0_by_region
#PBS -S /bin/bash
...
-parquet_genotype ../input/gtex_v8_parquet_eur_maf0.01_biallelic/gtex_v8_eur_itm.chr16.variants.parquet \
...
-sub_batch 0 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/meta_analysis_BCAC_UKB_ovr_brca_chr16_sb0_reg0.1_ff0.01_by_region.txt.gz