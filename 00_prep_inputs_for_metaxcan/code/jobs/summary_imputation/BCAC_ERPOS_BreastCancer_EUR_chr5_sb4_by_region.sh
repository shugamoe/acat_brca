#!/bin/bash
#PBS -N BCAC_ERPOS_BreastCancer_EUR_chr5_sb4_by_region
#PBS -S /bin/bash
...
-sub_batch 4 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/BCAC_ERPOS_BreastCancer_EUR_chr5_sb4_reg0.1_ff0.01_by_region.txt.gz