#!/bin/bash
#SBATCH --job-name=intrinsic_subtype_4_chr18_sb9_by_region
#SBATCH --time=4:00:00
#SBATCH --mem=3gb
#SBATCH --nodes=1
...
-sub_batch 9 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/intrinsic_subtype_4_chr18_sb9_reg0.1_ff0.01_by_region.txt.gz