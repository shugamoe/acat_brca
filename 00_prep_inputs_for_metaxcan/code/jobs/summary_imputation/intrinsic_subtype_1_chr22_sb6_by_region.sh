#!/bin/bash
#SBATCH --job-name=intrinsic_subtype_1_chr22_sb6_by_region
#SBATCH --time=4:00:00
#SBATCH --mem=2gb
#SBATCH --nodes=1
...
-sub_batch 6 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/intrinsic_subtype_1_chr22_sb6_reg0.1_ff0.01_by_region.txt.gz