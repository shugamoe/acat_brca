#!/bin/bash
#SBATCH --job-name=intrinsic_subtype_2_chr10_sb5_by_region
#SBATCH --time=4:00:00
#SBATCH --mem=4gb
#SBATCH --nodes=1
...
-sub_batch 5 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/intrinsic_subtype_2_chr10_sb5_reg0.1_ff0.01_by_region.txt.gz