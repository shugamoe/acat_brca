#!/bin/bash
#SBATCH --job-name=intrinsic_subtype_2_chr17_sb2_by_region
#SBATCH --time=4:00:00
#SBATCH --mem=3gb
#SBATCH --nodes=1
...
-sub_batch 2 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/intrinsic_subtype_2_chr17_sb2_reg0.1_ff0.01_by_region.txt.gz