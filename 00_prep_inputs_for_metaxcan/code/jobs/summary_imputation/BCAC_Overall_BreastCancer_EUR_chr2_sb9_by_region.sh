#!/bin/bash
#PBS -N BCAC_Overall_BreastCancer_EUR_chr2_sb9_by_region
#PBS -S /bin/bash
...
-sub_batch 9 \
--standardise_dosages \
-output ../output/metaxcan_gwas_impute_regions/BCAC_Overall_BreastCancer_EUR_chr2_sb9_reg0.1_ff0.01_by_region.txt.gz